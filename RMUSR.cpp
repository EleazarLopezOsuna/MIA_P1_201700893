...
void RMUSR::ejecutar_RMUSR(objetos::activeUser * usuario, lista::list * lista){
    if(strcmp(usuario->user, "root") != 0){
        cout << "Error, no se tienen los permisos para eliminar usuarios" << endl;
        return;
    }
